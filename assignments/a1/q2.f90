...
!constants
integer, parameter :: n=10 !choose number of samples
...
open(1, file = './output/output_q2/q2_10terms_sample.dat', status='unknown')
do i=1,n
  y(i)=f(x(i))
  write(1,*)  x(i), y(i)
end do
...
open(1, file = './output/output_q2/q2_10terms_approx.dat', status='unknown')
