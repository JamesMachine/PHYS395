...
open(1, file = './output/output_q3/q3_10terms_sample.dat', status='unknown')
do i=1,n
  y(i)=f(x(i))
  write(1,*)  x(i), y(i)
end do
...
open(1, file = "./output/output_q3/q3_10terms_expected.dat", status='unknown')
do i=1,k
...
open(1, file = "./output/output_q3/q3_10terms_approx.dat", status='unknown')
