...
!gfortran -fdefault-real-8 q3_2.f90 -o q3_2 && ./q3_2
...
open(1, file = 'output3_1_2.csv', status='unknown')
do i=1,n
  y(i)=f(x(i))
  write(1,*)  x(i), y(i)
end do
...
open(1, file = 'output3_2_2.csv', status='unknown')
do i=1,k
...
open(1, file = 'output3_3_2.csv', status='unknown')
