...
lower=[0.38,1.47,2.92,4.50,6.40,8.32,10.48,12.60,14.90,17.40]
upper=[0.54,1.51,3.09,4.70,6.50,8.55,10.60,12.80,15.10,17.60]

! use biesction method to compute the eigenvalues given the quartic potential
write(*,*) "The eigenvalues for the quartic potential are:"
do h=1,10
	...
	write(*,*) bisect(lower(h), upper(h), par)
end do
