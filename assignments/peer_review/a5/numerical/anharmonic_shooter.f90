! dinger.f90 integrate Schrodingerequation from x=0 to infinity
! outputs some files:
! fort.1 is x, psi, psi^2, and normalization for a given E. Created in dump
...
! fort.4 is the list of eigenvalues
! fort.5 is boundary condition violation far from x=0
! compile with: gfortran -O3 -fdefault-real-8 anharmonic_shooter.f90 
program anharmonic_shooter
implicit none
...
write (*,*) 'An energy eigenvalue of -1.0 means an eigenvalue was not found in the interval'
