! wrong_harmonic_shooter.f90 integrate Schrodingerequation from x=0 to infinity
! using the shooting method with incorrect eigenvalues
...
! compile with: gfortran -O3 -fdefault-real-8 wrong_harmonic_shooter.f90 
program wrong_harmonic_shooter
implicit none
...
write (4,'(4g24.16)') 'Eigenvalue:', roots(1), 'Boundary Violation:', violation(1)
write (4,'(4g24.16)') 'Eigenvalue:', roots(2), 'Boundary Violation:', violation(2)
