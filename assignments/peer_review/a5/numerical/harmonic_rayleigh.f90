! harmonic_rayleigh.f90 - solve Schrodinger's equation using dgeev()
! fort.1 is eigenfunctions
! fort.4 is eigenvalues
! compile with: gfortran -O3 -fdefault-real-8 harmonic_rayleigh.f90 -llapack

program harmonic_rayleigh
implicit none
