! Assignment5 - Q5
!gfortran -O3 -fdefault-real-8 shrodinger_dgeev_q5.f90 -o shrodinger_dgeev_q5 && ./shrodinger_dgeev_q5

program shrodinger_dgeev_q5; implicit none
...
contains
  ...
  subroutine dump(x,WR,VR)
    ...
    open(1,file="./output/output_q5/q5_E")
    ...
    ! write all the psi
    open(1,file="./output/output_q5/q5_psi")
    do i=1,n
      do j=1,n
