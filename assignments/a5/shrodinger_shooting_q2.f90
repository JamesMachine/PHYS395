! For Assignment 5 -  Q2 -  solve BVP using shooting method
! compile with: gfortran -O3 -fdefault-real-8 shrodinger_shooting_q2.f90 -o shrodinger_shooting_q2 && ./shrodinger_shooting_q2

program shrodinger_shooting_q2
implicit none
...
!step3: Dump
open(1,file = "./output/output_q2/q2_E")
do i=1,10
  write(1,*) E_array(i)
end do
close(1)

open(1,file = "./output/output_q2/q2_psi")
do ii=1,10
  do i=1,2*n-1
