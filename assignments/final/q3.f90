...
! compile and run with: gfortran -O3 -fdefault-real-8 q3.f90 -lcfitsio -o q3 && ./q3
...
program q3; implicit none
  ...
  open(1,file = "./output/output_q3/psi.dat")

  write(*,*) "q3 started ..."

  u = [ a, 0.0 ] !initial values for IVP
  tlength = 15
  u = integrate(u, tlength, dt, .true.) !true if you want to write into file "results"
  write(*,*) ""
  write(*,*) ""
...
contains
  ...
  function integrate(u, t, dt, writeFlag)
    ...
    do i = 1,n
      ...
      if(writeFlag) then
        !write (*,*) (i-1)*dt, u(1), u(2), Evio
        write (1,*) (i-1)*dt, u(1), u(2), Evio
      end if
    end do
    call gl10(u,t-n*dt)
