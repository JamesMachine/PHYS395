...
! compile and run with: gfortran -O3 -fopenmp dbpend_phsp4.f90 -lcfitsio -o dbpend_phsp4 && ./dbpend_phsp4
...
program dbpened_phsp; implicit none
 ...
 xx = [0.8, 0.9]
 yy = [-2.0, -1.9]
  write(*,*) "Q3: phase space (zoom 3) scan starts..."
  ...
  !$omp end parallel do
  write(*,*) "phase space (zoom 3) scan ends..."

  ! write out image to file
  call write2fits('./output/data4.fit', data, xx, yy, ['th1 ','th2 ','thd1','thd2'], '(th1(0),th2(0))')
