...
hdu = pyfits.open('./output_longrun/data.fit')
...
# plot image data
c = matplotlib.colors.LinearSegmentedColormap.from_list("difference", ["green", "red", "purple", "blue","white"])
im = imshow(data, extent=(x[0],x[-1],y[0],y[-1]), aspect=(osx*dx)/(osy*dy), cmap=c, interpolation='none')
...
plt.savefig('./output_longrun/data.png')
